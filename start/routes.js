...
Route.put('/editTeam/:team_id', 'TeamCreation/TeamManagementController.editTeam').middleware(['auth'])
Route.get('/viewUserTeam/:team_id', 'TeamCreation/TeamManagementController.viewUserTeam').middleware(['auth'])
